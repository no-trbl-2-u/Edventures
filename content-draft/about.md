...
Animals have always been a huge part of my life, and I bring **15 years of hands-on experience** caring for pets of all kinds. My background includes pet sitting, animal rescue, and work in veterinary medicine, giving me the opportunity to care for animals with a wide range of personalities, needs, medical conditions, and routines.
...
## Open item — "work in veterinary medicine"

The two source drafts disagree, so the merge uses deliberately vague wording:

- `About me.png` — "volunteering in veterinary clinics"
- `AboutMe.jpeg` — "veterinary medicine as a **CSR**" (presumably Client Service Representative)

These describe different roles. The merge says "work in veterinary medicine," which is safe but weak.
